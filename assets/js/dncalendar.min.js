...
var headerGroup=$("<div id='dncalendar-header' class='dncalendar-header'></div>");headerGroup.append("<h2>"+headerMonth+" <span>"+y+"</span></h2>");var prevInactive=!1;var minDate=null;if(typeof settings.minDate!=='undefined'){var minDateArr=settings.minDate.split('-');minDate=new Date(minDateArr[0],minDateArr[1]-1,minDateArr[2]);if(minDate.getFullYear()>=y){if(minDate.getMonth()>=m){prevInactive=!0}}}
